    ...
    <UserLogin title="Registration">
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="space-y-5 p-8 rounded-md shadow-md bg-slate-50">
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                } text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 focus:outline-none block w-full ps-10 p-2.5 autofill:shadow-none`}
                placeholder="Email"
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                } text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 focus:outline-none block w-full ps-10 p-2.5 autofill:bg-slate-100 autofill:text-gray-900`}
              ...
              <div className="absolute inset-y-0 right-0 pr-2 flex items-center text-sm leading-5">
                <button
                  type="button"
                  className="icon-button text-gray-600 bg-sky-600 hover:bg-sky-500 focus:outline-none border-0"
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                ...
                className={`bg-slate-100 border border-gray-300 ${
                  formik.errors.password ? "bg-red-50 border-red-500" : ""
                } text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 focus:outline-none block w-full ps-10 p-2.5`}
          ...
          <button
            className="w-full p-3 bg-sky-600 hover:bg-sky-500 text-white border-0"
